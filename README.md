...
# 宗旨
中书省可以让你避开终端直接以图形化界面在opt等文件夹中删除、重命名、移动文件。开发中书省是因为希望更多人可以入坑Ubuntu，毕竟一个开源的系统至少比Windows安全些。对于目标职业是政府机关的电脑小白来说，以此过渡到银河麒麟和统信UOS也会更顺利些，永远要重视国家信息安全，这也是我们崇拜华为的原因
# 图标
本图标使用通义万象生成
